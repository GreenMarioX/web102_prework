...
raisedCard.innerHTML = `Total Raised: $${GAMES_JSON.reduce((total, game) => total + game.pledged, 0).toLocaleString()}`;

// grab number of games card and set its inner HTML
const gamesCard = document.getElementById("num-games");

const numCard = document.getElementById("num-games");
numCard.innerHTML = `Number of Games: ${GAMES_JSON.length}`;
...
function filterUnfundedOnly() {
    ...
    console.log(GAMES_JSON.filter( (game) => game.pledged < game.goal));
}
...
const unfundedGamesString = numUnfundedGames === 1 ? "1 game" : `${numUnfundedGames} games`;

// create a new DOM element containing the template string and append it to the description container
const unfundedGames = document.createElement("p");
unfundedGames.innerHTML = `We have ${unfundedGamesString} that still need funding!`;
